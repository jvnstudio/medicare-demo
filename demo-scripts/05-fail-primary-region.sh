...
echo " Stops nginx on ALL primary MIG VMs."
echo " VMs remain running; the application health endpoint fails."
echo "============================================================"
...
echo "Watch 02-watch-migs.sh and 04-watch-health.sh in separate terminals."
